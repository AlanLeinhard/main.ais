...
service = Item(title='Elastic', desc='DitLab кафедры АИС',
               url_serv="https://192.168.100.150:5601", image=image)
...
service = Item(title='Grafana', desc='Grafana кафедры АИС',
               url_serv="https://192.168.100.150:3005", image=image)
db.session.add(service)
db.session.commit()
print("done")
...
service = Item(title='Postgres', desc='Postgres кафедры АИС',
               url_serv="https://192.168.100.150:5050", image=image)
db.session.add(service)
db.session.commit()
print("done")
...
service = Item(title='Prometheus', desc='Prometheus кафедры АИС',
               url_serv="https://192.168.100.150:9095", image=image)
db.session.add(service)
db.session.commit()
print("done")
...
service = Item(title='Runcher', desc='Runcher кафедры АИС',
               url_serv="https://92.168.100.150:4443", image=image)
db.session.add(service)
db.session.commit()
print("done")
...
service = Item(title='GitLab', desc='GitLab кафедры АИС',
               url_serv="https://92.168.100.150:4445", image=image)
db.session.add(service)
db.session.commit()
print("done")
...
service = Item(title='Docker', desc='Docker кафедры АИС',
               url_serv="https://92.168.100.150:8086", image=image)
db.session.add(service)
db.session.commit()
print("done")
...
service = Item(title='Nextcloud', desc='Nextcloud кафедры АИС',
               url_serv="https://92.168.100.150:8100", image=image)
db.session.add(service)
db.session.commit()
print("done")
...
service = Item(title='Nexus', desc='Nexus кафедры АИС',
               url_serv="https://92.168.100.150:8081", image=image)
db.session.add(service)
db.session.commit()
print("done")
...
service = Item(title='CTF', desc='CTF кафедры АИС',
               url_serv="https://92.168.100.150:8002", image=image)
db.session.add(service)
db.session.commit()
print("done")
...
service = Item(title='VS Code', desc='VS Code кафедры АИС',
               url_serv="https://92.168.100.150:8087", image=image)
db.session.add(service)
db.session.commit()
print("done")
...
service = Item(title='CodiMD', desc='CodiMD кафедры АИС',
               url_serv="https://92.168.100.150:3000", image=image)
db.session.add(service)
db.session.commit()
print("done")
